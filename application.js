...
IGVModule.prototype.fillChrome = function () {
    let pStr = '<div class="panel panel-default"><div class="panel-heading">' +
        ...
        '</div></div><div class="col-md-1"><button class="kill-igv-browser">Hide</button></div>' +
        '</div></div>' +
        ...
        availableFiles
            ...
            .reduce(
                function(chain, filePromise) {
                    return chain.then(function(){return filePromise})
                },
                Promise.resolve() //fulfilled Promise to start the reduce chain.
            )
            .then(function(){
                psf.publish('CandidateFilesParsed', {data: psf.pepsByFile});
            });
    };
